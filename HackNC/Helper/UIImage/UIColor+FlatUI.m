...
+(UIColor *)facebookColor{
	static UIColor *facebook = nil;
	static dispatch_once_t facebookToken;
	
	dispatch_once(&facebookToken, ^{
		facebook = [UIColor colorFromHexCode:@"3B5998"];
	});
	return facebook;
}
...
+(UIColor *)facebookColorDark{
	...
	dispatch_once(&facebookToken, ^{
		facebook = [UIColor colorFromHexCode:@"2F477A"];
	});
	return facebook;
}
